                  ...
                  {currentProducts.length > 0 ? (
                    currentProductsFiltered.map((product: any) => (
                      <ProductCard
                        ...
                        image={`/images/ผู้ประกอบการ/koyori_${product.businessinfo?.DataYear}/${product.businessinfo?.BussinessNameEng.replace(/\s+/g, '')}/Product/${product.productName.replace(/\s+/g, '')}/${product.image}` || ""}
                      />
                    ))
                  ) : (
                    <p>ไม่พบสมาชิก</p>
