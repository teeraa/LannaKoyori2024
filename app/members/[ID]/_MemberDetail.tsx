  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 py-4 px-0">
        <div className="bg-white/75 flex flex-col sm:flex-row gap-4 p-4 sm:p-6 rounded-md z-10 border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5 gap-4">
          ...
          {roleThai === "ครูช่าง" && (
            <div className="col-span-1 md:col-span-3 mt-4 space-y-4">
              <div className="border border-gray-100 rounded-md p-4 bg-gradient-to-t from-white to-white/75 z-10 relative overflow-hidden">
                <h1 className="text-[24px] font-bold mb-4 text-blue-950">ร้านค้าผู้ประกอบการ</h1>
              </div>
            </div>
          )}
        </div>
